...
In addition, your device has a built-in joltage adapter rated for `3` _jolts higher_ than the highest-rated adapter in your bag. (If your adapter list were `3`, `9`, and `6`, your device's built-in adapter would be rated for `12` jolts.)
...
In this example, when using every adapter, there are `7` differences of 1 jolt and _`5`_ differences of 3 jolts.
